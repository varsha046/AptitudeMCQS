...
const parent_json_file_path = "./final_responses/" + parent_json_file_name + "_final_responses.json";
const prompt_paraphrase_json_file_path = "./Parphrase_Explanation/" + parent_json_file_name + "_p_E.json";
...
fs.readFile(parent_json_file_path, "utf8", (readErr, questions_data) => {
  ...
  fs.readFile("./prompt_pe.md", "utf8", (err, prompt) => {
    if (err) {
