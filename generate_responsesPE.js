...
const prompts_paraphrase_json_file_name = parent_json_file_name + "_p_E.json";
const prompts_paraphrase_path = "./Parphrase_Explanation/" + prompts_paraphrase_json_file_name;
const responses_paraphrase_path = "./responses_PE/" + parent_json_file_name + "_r_PE.json";
