...
const extractQuestionsData = (prompt_responses) => {
    ...
    prompt_responses.forEach(prompt_response => {
        ...
        question_data["question_type"] = prompt_response["question_type"];
            question_data["option-1"]=prompt_response["option-1"];
            question_data["option-1-Type"]=prompt_response["option-1-Type"];
            question_data["option-2"]=prompt_response["option-2"];
            question_data["option-2-Type"]=prompt_response["option-2-Type"];
            question_data["option-3"]=prompt_response["option-3"];
            question_data["option-3-Type"]=prompt_response["option-3-Type"];
            question_data["option-4"]=prompt_response["option-4"];
            question_data["option-4-Type"]=prompt_response["option-4-Type"];
            question_data["Answer"]=prompt_response["Answer"];
            question_data["Explanation"]=prompt_response["Explanation"];
            question_data["Explanation-type"]=prompt_response["Explanation-type"];
            question_data["analyzed answer"]=prompt_response["analyzed answer"];
            question_data["Matchness"]=prompt_response["Matchness"];
